...
class __MyTemplates_153d9de4247acc7c851fcae165252f5e extends Mustache_Template
{
...
';
        ...
        $buffer .= $this->sectionDe0ca11bba8edcd624d4aba2f6dc52ed($context, $indent, $value);
...
';
    ...
    private function sectionDe0ca11bba8edcd624d4aba2f6dc52ed(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
        if (is_object($value) && is_callable($value)) {
            $source = '
