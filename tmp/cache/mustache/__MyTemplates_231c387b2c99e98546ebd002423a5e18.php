...
class __MyTemplates_231c387b2c99e98546ebd002423a5e18 extends Mustache_Template
{
...
';
        ...
        $buffer .= $this->section175192b18455e716a3f835fba7397326($context, $indent, $value);
...
';
    ...
    private function section175192b18455e716a3f835fba7397326(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
        if (is_object($value) && is_callable($value)) {
            $source = '
