...
class __MyTemplates_2ce9ff69503b96dde5bc1cbbf5a5004f extends Mustache_Template
{
...
';
        $buffer .= $indent . '                            <img class="logo-light logo-img logo-img-lg" src="./assets/images/logo-dark.png" srcset="./assets/images/logo-dark2x.png.png 2x" alt="logo">
';
...
';
        $buffer .= $indent . '                                <p>Access your RDT Capital Account using your email and password</p>
';
        $buffer .= $indent . '                            </div>
';
        $buffer .= $indent . '                        </div>
...
';
        $buffer .= $indent . '                                <a class="nav-link" href="https://www.rdtmarkets.com/terms-of-service/"target="_blank">Terms of Service</a>
';
        $buffer .= $indent . '                            </li>
';
        $buffer .= $indent . '                            <li class="nav-item">
';
        $buffer .= $indent . '                                <a class="nav-link" href="https://www.rdtmarkets.com/privacy-policy/"target="_blank">Privacy Policy</a>
';
        $buffer .= $indent . '                                  <li class="nav-item">
';
        $buffer .= $indent . '                                <a class="nav-link" href="https://www.rdtmarkets.com/faq/"target="_blank">FAQ</a>
';
        $buffer .= $indent . '                            </li>
';
        $buffer .= $indent . '                            </li>
...
';
        $buffer .= $indent . '                        <p>&copy; 2023 RDT Capital. All Rights Reserved.</p>
';
        $buffer .= $indent . '                    </div>
';
        $buffer .= $indent . '                </div>
...
';
        $buffer .= $indent . '                                    <h4>Rdtmarkets Online</h4>
';
        $buffer .= $indent . '                                    <p>Cryptocurrency works harder and smarter with <br> Rdtmarkets</p>
';
        $buffer .= $indent . '                                </div>
';
        $buffer .= $indent . '                            </div>
