...
class __MyTemplates_9828ea89128b177f33db40a09eeb59b0 extends Mustache_Template
{
    ...
    public function renderInternal(Mustache_Context $context, $indent = '')
    {
        ...
        $buffer .= $this->section49bd623156419a027357b8c3f20e1d16($context, $indent, $value);
...
';
    ...
    private function section7abe0951ea145ad0cc83ea7cd8792287(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
        if (is_object($value) && is_callable($value)) {
            $source = '
                                                            ...
                                                            <div class="form-group">
                                                                <div class="form-control-wrap">
                                                                    ...
                                                                    <select class="form-select" id="accountManager" name="accountManager" required>
                                                                        <option value="Brian Lambert">Brian Lambert</option>
                                                                            <option value="David King">David King</option>
                                                                        <option value="Adam Roth">Adam Roth</option>
...
';
                $buffer .= $indent . '                                                                        <option value="Brian Lambert">Brian Lambert</option>
';
                $buffer .= $indent . '                                                                            <option value="David King">David King</option>
';
                $buffer .= $indent . '                                                                        <option value="Adam Roth">Adam Roth</option>
';
                $buffer .= $indent . '                                                                        
';
                $buffer .= $indent . '                                                                    </select>
...
';
    ...
    private function section49bd623156419a027357b8c3f20e1d16(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
        if (is_object($value) && is_callable($value)) {
            $source = '
...
';
            ...
            foreach ($values as $value) {
                ...
                $buffer .= $this->section7abe0951ea145ad0cc83ea7cd8792287($context, $indent, $value);
                $context->pop();
            }
        }
