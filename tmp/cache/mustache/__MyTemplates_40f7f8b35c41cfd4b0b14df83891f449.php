...
class __MyTemplates_40f7f8b35c41cfd4b0b14df83891f449 extends Mustache_Template
{
    ...
    public function renderInternal(Mustache_Context $context, $indent = '')
    {
        ...
        $buffer .= $this->section751a6f0bdff770050f1fcd4d81df8661($context, $indent, $value);

        return $buffer;
    }

    private function sectionD6af9c1e4552f141b419b527f5c4098f(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
            ...
            $source = '
                                    <div class="form-group example-alert">
                                        <div class="alert alert-success alert-icon alert-dismissible">
                                            <em class="icon ni ni-check-circle"></em> Trade has been added. <button class="close" data-dismiss="alert"></button>
                                        </div>
                                    </div>
                                    ';
...
';
                $buffer .= $indent . '                                            <em class="icon ni ni-check-circle"></em> Trade has been added. <button class="close" data-dismiss="alert"></button>
';
                $buffer .= $indent . '                                        </div>
';
                $buffer .= $indent . '                                    </div>
';
    ...
    private function section751a6f0bdff770050f1fcd4d81df8661(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
        if (is_object($value) && is_callable($value)) {
            $source = '
...
';
                ...
                $buffer .= $this->sectionD6af9c1e4552f141b419b527f5c4098f($context, $indent, $value);
