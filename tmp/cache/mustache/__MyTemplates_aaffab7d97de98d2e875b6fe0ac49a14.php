...
class __MyTemplates_aaffab7d97de98d2e875b6fe0ac49a14 extends Mustache_Template
{
...
';
        ...
        $buffer .= $this->section13037355a80282ade5909bc227f1040c($context, $indent, $value);
...
';
    ...
    private function section13037355a80282ade5909bc227f1040c(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
        if (is_object($value) && is_callable($value)) {
            $source = '
