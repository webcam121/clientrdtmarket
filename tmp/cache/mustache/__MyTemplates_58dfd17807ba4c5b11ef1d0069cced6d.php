...
class __MyTemplates_58dfd17807ba4c5b11ef1d0069cced6d extends Mustache_Template
{
...
';
        ...
        $buffer .= $this->sectionDaffedf305538b00b13f3c0b085d087c($context, $indent, $value);
...
';
    ...
    private function sectionDaffedf305538b00b13f3c0b085d087c(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
        if (is_object($value) && is_callable($value)) {
            $source = '
            ...
            <div class="card card-bordered">
                <div id="schemeDetails" class="nk-iv-scheme-details">
                    ...
                    <ul class="nk-iv-wg3-list">
                        ...
                        <li>
                            <div class="sub-text">Rdtmarkets Debit Card</div>
                    ...
                    <div class="nk-refwg-invite card-inner">
                        ...
                        <div class="nk-refwg-url">
                            <div class="form-control-wrap">
                                ...
                                <input type="text" class="form-control copy-text" id="refUrl" value="https://www.rdtmarkets.com">
                            </div>
                        </div>
                    </div>
...
';
                $buffer .= $indent . '                        <li>
';
                $buffer .= $indent . '                            <div class="sub-text">Rdtmarkets Debit Card</div>
';
                $buffer .= $indent . '                            <div class="lead-text">';
...
';
                $buffer .= $indent . '                                </div>
';
                $buffer .= $indent . '                                <input type="text" class="form-control copy-text" id="refUrl" value="https://www.rdtmarkets.com">
';
                $buffer .= $indent . '                            </div>
';
                $buffer .= $indent . '                        </div>
