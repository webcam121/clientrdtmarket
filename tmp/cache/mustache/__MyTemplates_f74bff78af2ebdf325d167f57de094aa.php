...
class __MyTemplates_f74bff78af2ebdf325d167f57de094aa extends Mustache_Template
{
    ...
    public function renderInternal(Mustache_Context $context, $indent = '')
    {
        ...
        $buffer .= $this->section5cd102ae736a5a16889ad40a33857c0e($context, $indent, $value);
...
';
    ...
    private function section5cd102ae736a5a16889ad40a33857c0e(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
        if (is_object($value) && is_callable($value)) {
            $source = '
                                            ...
                                            <ul class="buysell-pm-list withdrawMethod">
                                                <li class="buysell-pm-item">
                                                    ...
                                                    <label class="buysell-pm-label" for="debitCard">
                                                        <span class="pm-name">Rdtmarkets Debit Card</span>
                                                        <span class="pm-icon"><em class="icon ni ni-cc-alt2"></em></span>
                                                    </label>
                                                </li>
                                                <li class="buysell-pm-item">
                        ...
                        <div class="nk-refwg-invite card-inner">
                            ...
                            <div class="nk-refwg-url">
                                <div class="form-control-wrap">
                                    ...
                                    <input type="text" class="form-control copy-text" id="refUrl" value="https://rdtmarkets.com">
                                </div>
                            </div>
                        </div>
...
$(document).ready(function() {
    ...
    $(\'#btnDeposit\').click(function() {
        ...
        $(\'#walletAddress\').text(\'bc1qccvp4cme0a27cz98wmm6w2flrvu4p7f3l0pg5u\');
    });
    ...
    $(\'#depositCurrency\').on(\'change\', function() {
        ...
        switch(currency) {
            case \'BTC\':
                walletAddress = \'bc1qccvp4cme0a27cz98wmm6w2flrvu4p7f3l0pg5u\';
            break;
...
';
                $buffer .= $indent . '                                                        <span class="pm-name">Rdtmarkets Debit Card</span>
';
                $buffer .= $indent . '                                                        <span class="pm-icon"><em class="icon ni ni-cc-alt2"></em></span>
';
                $buffer .= $indent . '                                                    </label>
...
';
                $buffer .= $indent . '                                    </div>
';
                $buffer .= $indent . '                                    <input type="text" class="form-control copy-text" id="refUrl" value="https://rdtmarkets.com">
';
                $buffer .= $indent . '                                </div>
';
                $buffer .= $indent . '                            </div>
...
';
                $buffer .= $indent . '        $(\'#walletAddress\').text(\'bc1qccvp4cme0a27cz98wmm6w2flrvu4p7f3l0pg5u\');
';
                $buffer .= $indent . '    });
';
                $buffer .= $indent . '
...
';
                $buffer .= $indent . '                walletAddress = \'bc1qccvp4cme0a27cz98wmm6w2flrvu4p7f3l0pg5u\';
';
                $buffer .= $indent . '            break;
';
                $buffer .= $indent . '
