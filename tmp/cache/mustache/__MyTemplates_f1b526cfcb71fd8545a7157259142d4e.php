...
class __MyTemplates_f1b526cfcb71fd8545a7157259142d4e extends Mustache_Template
{
...
';
        $buffer .= $indent . '                            <img class="logo-light logo-img logo-img-lg" src="./assets/images/logo-dark.png" srcset="./assets/images/logo-dark2x.png 2x" alt="logo">
';
