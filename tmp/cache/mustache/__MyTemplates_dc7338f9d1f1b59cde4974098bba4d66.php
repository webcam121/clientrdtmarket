...
';
        $buffer .= $indent . '                                <a class="nav-link" href="https://rdtmarkets.com/terms-of-service/"target="_blank">Terms of Service</a>
';
        $buffer .= $indent . '                            </li>
';
        $buffer .= $indent . '                            <li class="nav-item">
';
        $buffer .= $indent . '                                <a class="nav-link" href="https://rdtmarkets.com/privacy-policy/"target="_blank">Privacy Policy</a>
';
        $buffer .= $indent . '                                  <li class="nav-item">
';
        $buffer .= $indent . '                                <a class="nav-link" href="https://rdtmarkets.com/faq/"target="_blank">FAQ</a>
';
        $buffer .= $indent . '                            </li>
';
        $buffer .= $indent . '                            </li>
