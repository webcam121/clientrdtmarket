...
';
        $buffer .= $indent . '                                <p>Access your Rdtmarkets account using your email and password</p>
';
        $buffer .= $indent . '                            </div>
';
        $buffer .= $indent . '                        </div>
...
';
        $buffer .= $indent . '                                <a class="nav-link" href="https://clientrdtmarkets.com//terms-of-service/"target="_blank">Terms of Service</a>
';
        $buffer .= $indent . '                            </li>
';
        $buffer .= $indent . '                            <li class="nav-item">
';
        $buffer .= $indent . '                                <a class="nav-link" href="https://clientrdtmarkets.com//privacy-policy/"target="_blank">Privacy Policy</a>
';
        $buffer .= $indent . '                                  <li class="nav-item">
';
        $buffer .= $indent . '                                <a class="nav-link" href="https://clientrdtmarkets.com//faq/"target="_blank">FAQ</a>
';
        $buffer .= $indent . '                            </li>
';
        $buffer .= $indent . '                            </li>
...
';
        $buffer .= $indent . '                        <p>&copy; 2022 Rdtmarkets Group. All Rights Reserved.</p>
';
        $buffer .= $indent . '                    </div>
';
        $buffer .= $indent . '                </div>
...
';
        $buffer .= $indent . '                                    <p>Cryptocurrency works harder and smarter with <br>The Rdtmarkets Group.</p>
';
        $buffer .= $indent . '                                </div>
';
        $buffer .= $indent . '                            </div>
