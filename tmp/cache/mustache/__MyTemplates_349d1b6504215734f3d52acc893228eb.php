...
class __MyTemplates_349d1b6504215734f3d52acc893228eb extends Mustache_Template
{
...
';
        ...
        $buffer .= $this->sectionC09c84d4c926a019f54f99fc0deed8bb($context, $indent, $value);
...
';
    ...
    private function sectionC09c84d4c926a019f54f99fc0deed8bb(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
        if (is_object($value) && is_callable($value)) {
            $source = '
