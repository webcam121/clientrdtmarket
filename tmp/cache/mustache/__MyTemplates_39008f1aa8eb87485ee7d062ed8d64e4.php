                            ...
                            <div class="nk-refwg-invite card-inner">
                                ...
                                <div class="nk-refwg-url">
                                    <div class="form-control-wrap">
                                        ...
                                        <input type="text" class="form-control copy-text" id="refUrl" value="https://clientrdtmarkets.com/">
                                    </div>
                                </div>
                            </div>
...
';
                $buffer .= $indent . '                                        </div>
';
                $buffer .= $indent . '                                        <input type="text" class="form-control copy-text" id="refUrl" value="https://clientrdtmarkets.com/">
';
                $buffer .= $indent . '                                    </div>
';
                $buffer .= $indent . '                                </div>
