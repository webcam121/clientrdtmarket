...
class __MyTemplates_fcc292f5475e12cd38e196aa0955662c extends Mustache_Template
{
...
';
        ...
        $buffer .= $this->section5043f89024005fa085cb08284124ffeb($context, $indent, $value);
...
';
    ...
    private function section5043f89024005fa085cb08284124ffeb(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
        if (is_object($value) && is_callable($value)) {
            $source = '
